...
<body class="bg-light">
  ...
  <main>
    <article class="container-fluid mt-1 pagination justify-content-center">
      <h4>FANTASY BOOKS<span class="badge bg-secondary">New</span></h4>
    </article>
    <section class="mt-3">
      <form action="fantasyProcess.php" class="pagination justify-content-center" method="POST">
    ...
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM books WHERE type = 'fantasy' ORDER BY pub_date DESC";
